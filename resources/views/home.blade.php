...
<section class="hero" aria-labelledby="hero-heading">
    ...
    <div class="hero-art">
        ...
        <div class="envelope" id="hero-envelope">
            ...
            <button class="paper paper-middle" type="button" data-card-reveal="create" aria-label="Buka kartu Make Something" aria-expanded="false"><span class="paper-word">MAKE<br><em>something.</em></span><span class="paper-small">A SPACE FOR SMALL IDEAS</span><span class="card-message">Ide kecil menjadi berarti ketika diwujudkan dan dibagikan.</span></button>
