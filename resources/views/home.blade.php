...
<section class="hero" aria-labelledby="hero-heading">
    <div class="hero-copy">
        <p class="eyebrow"><span class="status-dot"></span> Informatics student Â· ITS</p>
        <h1 id="hero-heading">HELLO!<br>Iâ€™M <em>KAMAL.</em></h1>
        ...
        <a class="text-link" href="#playground">Come take a look around <span aria-hidden="true">â†˜</span></a>
    </div>
    <div class="hero-art">
        <span class="art-caption">01 / A WORK IN CURIOSITY</span>
        <div class="envelope" id="hero-envelope">
            <div class="paper paper-back"><span>KEEP<br>EXPLORING.</span><span class="paper-cross" aria-hidden="true">âœ³</span></div>
            ...
            <div class="paper paper-front"><span class="paper-number">K.</span><span class="paper-small">DESIGN Â· CODE Â· REPEAT</span></div>
    ...
    <div class="hero-bottom"><span>BASED IN SURABAYA, ID</span><a href="#playground">SCROLL TO EXPLORE <span aria-hidden="true">â†“</span></a></div>
</section>
...
<section class="content-section about-strip" id="about-me"><div><p class="eyebrow">02 / A LITTLE ABOUT ME</p><h2>Learning by making.<br><em>Making it personal.</em></h2></div><div><p>Aku {{ $profile['short_name'] }}, mahasiswa Teknik Informatika ITS. Website ini menjadi tempat untuk menghubungkan yang dipelajari di kelas dengan sesuatu yang bisa dilihat, dicoba, dan dikembangkan.</p><a class="text-link" href="{{ route('about') }}">My academic home <span aria-hidden="true">â†—</span></a></div></section>
<section class="content-section chapter-section" id="next-chapter"><p class="eyebrow">03 / THE NEXT CHAPTER</p><h2>What comes <em>next?</em></h2><p>Eksperimen hari ini bisa menjadi ide yang lebih besar besok.</p><a class="pill-button" href="{{ route('project') }}">Explore the project idea <span aria-hidden="true">â†—</span></a></section>
@endsection
