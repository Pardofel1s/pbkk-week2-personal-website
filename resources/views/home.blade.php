...
<section class="hero" aria-labelledby="hero-heading">
    ...
    <div class="hero-art">
        ...
        <div class="envelope" id="hero-envelope">
            ...
            <div class="card-detail" aria-hidden="true"><span class="card-detail-mark">K.</span><p>Tempat aku belajar, bereksperimen, dan membangun sesuatu dengan rasa ingin tahu.</p><span class="card-detail-meta">5025241153 · Surabaya, ID</span></div>
