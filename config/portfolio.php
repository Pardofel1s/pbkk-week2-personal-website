...
return [
    ...
    'short_name' => 'Kamal',
    'nrp' => '5025241153',
    'bio' => 'Saya Kamal, mahasiswa Teknik Informatika ITS angkatan 2024 yang senang membangun sistem cerdas di persimpangan software engineering, AI/data, networking, dan decision science. Saya menikmati proses mengubah masalah nyata menjadi sistem yang bisa dipahami, diuji, dan dikembangkan bersama tim.',
    'gpa' => '3.85',
    'credits' => 81,
    'academic_date' => '13 September 2026',
    'education' => [
        ['period' => '2024–sekarang', 'title' => 'S1 Teknik Informatika · ITS', 'detail' => 'Perkiraan kelulusan Juli 2028.'],
        ['period' => '2021–2023', 'title' => 'SMA Negeri 1 Tuban · IPA', 'detail' => 'Program percepatan; peringkat 10 dalam program dan 11 pada angkatan sekolah.'],
    ],
    'experience' => [
        ['period' => 'Januari 2026–sekarang', 'title' => 'Riset sistem jaringan · Laboratorium NCC ITS', 'detail' => 'Mempelajari perilaku komunikasi jaringan dan membangun pemahaman tentang sistem terdistribusi melalui eksperimen serta penyusunan paper.'],
        ['period' => 'Oktober–Desember 2025', 'title' => 'Kajian infrastruktur database · ITS', 'detail' => 'Mengkaji kebutuhan infrastruktur sistem RSUD Dr. Soetomo, termasuk redundansi, ketersediaan layanan, server, storage, dan jaringan.'],
        ['period' => 'Maret 2026–sekarang', 'title' => 'Staff Research and Technology · HMTC ITS', 'detail' => 'Mengembangkan SkenaIT dan InfoLomba serta menjadi Vice Project Officer Bluecamp 2026.'],
        ['period' => 'Maret 2026–sekarang', 'title' => 'Expert Staff of Technical · Schematics NLC', 'detail' => 'Merancang konsep permainan, mekanisme penilaian, dan alur kompetisi untuk babak lanjutan.'],
        ['period' => 'Oktober 2024–Februari 2025', 'title' => 'Project Officer · Ini Lho ITS! × Zenitron', 'detail' => 'Memimpin program pengenalan ITS yang menjangkau 42 sekolah dan lebih dari 300 peserta.'],
    ],
    ...
    'skills' => 'Python, C/C++, SQL, PHP, JavaScript, Laravel, Next.js, Git, Linux, machine learning, computer vision, analisis data, optimisasi, simulasi, networking, dan edge computing.',
    'brand' => 'K',
